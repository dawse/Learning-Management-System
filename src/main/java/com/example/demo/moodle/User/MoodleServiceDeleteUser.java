...
import java.net.URL;
/* URL
 * http://localhost/moodle/webservice/rest/server.php?wstoken=4c7dafc0ee45e5924125fc295fd737a7&wsfunction=core_user_delete_users&moodlewsrestformat=json
 */
public class MoodleServiceDeleteUser {
	...
	public void deleteUser(int userId) throws IOException {
	    ...
	    // Create parameters
	    String urlParameters = "userids[0]=" + userId;
