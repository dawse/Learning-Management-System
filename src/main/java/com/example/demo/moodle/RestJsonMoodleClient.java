...
public class RestJsonMoodleClient {
     ...
     */
        ...
        String token = "4c7dafc0ee45e5924125fc295fd737a7";
        ...
        "users[0][username]=" + URLEncoder.encode("dawssentest", "UTF-8") +/* */
        "&users[0][password]=" + URLEncoder.encode("Dawssentest123*/-#", "UTF-8") +/* */
        "&users[0][firstname]=" + URLEncoder.encode("testdawssen", "UTF-8") +/* */
        "&users[0][lastname]=" + URLEncoder.encode("testmadi", "UTF-8") +/* */
      ...
      //  "&users[0][theme]=" + URLEncoder.encode("standard", "UTF-8") +
        ...
        "&users[0][preferences][0][type]=" + URLEncoder.encode("preference100", "UTF-8") +
        "&users[0][preferences][0][value]=" + URLEncoder.encode("preferencevalue100", "UTF-8") +
        ...
        "&users[1][password]=" + URLEncoder.encode("testpassword2PASS123*/-", "UTF-8") +/* */
