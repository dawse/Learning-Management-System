...
/* URL
 * http://localhost/moodle/webservice/rest/server.php?wstoken=4c7dafc0ee45e5924125fc295fd737a7&wsfunction=core_user_update_users&moodlewsrestformat=json
 */
public class MoodleServiceUpdateUser {
    ...
    private static final String MOODLE_WS_FUNCTION_NAME = "core_user_update_users";
    private static final String MOODLE_WS_FORMAT = "json";

    public void updateUser(String userId, String firstname, String lastname, String email, String timezone,
            String city, String country) throws IOException {

        // Create REST URL
        String restUrl = MOODLE_DOMAIN_NAME + "/webservice/rest/server.php" + "?wstoken=" + MOODLE_API_TOKEN
                + "&wsfunction=" + MOODLE_WS_FUNCTION_NAME + "&moodlewsrestformat=" + MOODLE_WS_FORMAT;

        // Create parameters
        String urlParameters = "users[0][id]=" + URLEncoder.encode(userId, "UTF-8") 
